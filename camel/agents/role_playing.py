...
class RolePlaying:
    ...
    def __init__(
        ...
        print("with_task_specify:")
        print(with_task_specify)
        print("with_task_planner:")
        print(with_task_planner)


        if with_task_specify:
            print("with_task_specify:" + with_task_specify)
        ...
        if with_task_planner:
            print("with_task_planner:" + with_task_planner)
        ...
        print("with_critic_in_the_loop")
        print(with_critic_in_the_loop)
        if with_critic_in_the_loop:
            print("with_critic_in_the_loop:" + with_critic_in_the_loop)
    ...
    def step(
        ...
        print("userresponse调用咯诶诶诶诶诶诶诶诶1111")
